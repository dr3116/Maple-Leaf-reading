 ...
 * 杜然 12/1
 */
public class ClickFenLei9Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei9Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei9Activity newInstance(String str1) {
        ClickFenLei9Activity clickFenLei9Activity = new ClickFenLei9Activity();
        clickFenLei9Activity.str2= str1;
        return clickFenLei9Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","Python");
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei9Activity.this, BookIntroduction.class);
