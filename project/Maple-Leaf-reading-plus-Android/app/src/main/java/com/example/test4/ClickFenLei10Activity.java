 ...
 * 杜然 12/1
 */
public class ClickFenLei10Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei10Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei10Activity newInstance(String str1) {
        ClickFenLei10Activity clickFenLei10Activity = new ClickFenLei10Activity();
        clickFenLei10Activity.str2= str1;
        return clickFenLei10Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","MySQL");
                    FormBody body = builder.build();
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址
                            .post(body)
                            .url(ConfigUtil.SERVER_ADDR+"APP/GetBookList")
                            .build();
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei10Activity.this, BookIntroduction.class);
