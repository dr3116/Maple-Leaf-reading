...
//        Log.e("position",""+position);
        ...
        if ((position)*3<=bookShelfBooks.size()-1) {
            ...
            Glide.with(context)
                    .load(ConfigUtil.SERVER_ADDR+"images/book/"+bookShelfBooks.get((position)*3).getBookImg())
        ...
        if ((position)*3+1<=bookShelfBooks.size()-1) {
            ...
            Glide.with(context)
                    .load(ConfigUtil.SERVER_ADDR+"images/book/"+bookShelfBooks.get((position)*3+1).getBookImg())
                    .apply(requestOptions)
                    .into(bookImg2);
            Log.e("Book2设置成功","");
        ...
        if ((position)*3+2<=bookShelfBooks.size()-1) {
            ...
            Glide.with(context)
                    .load(ConfigUtil.SERVER_ADDR+"images/book/"+bookShelfBooks.get((position)*3+2).getBookImg())
                    .apply(requestOptions)
                    .into(bookImg3);
            Log.e("Book3设置成功","");
    ...
    private class MyListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            intent.setClass(context, LoadBookActivity.class);
