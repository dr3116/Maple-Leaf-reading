 ...
 * 杜然 12/1
 */
public class ClickFenLei4Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei4Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei4Activity newInstance(String str1) {
        ClickFenLei4Activity clickFenLei4Activity = new ClickFenLei4Activity();
        clickFenLei4Activity.str2= str1;
        return clickFenLei4Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","CSS3");
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei4Activity.this, BookIntroduction.class);
