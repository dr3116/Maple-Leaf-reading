...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLeiActivity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLeiActivity newInstance(String str1) {
        ClickFenLeiActivity clickFenLeiActivity = new ClickFenLeiActivity();
        clickFenLeiActivity.str2= str1;
        return clickFenLeiActivity;
    }
