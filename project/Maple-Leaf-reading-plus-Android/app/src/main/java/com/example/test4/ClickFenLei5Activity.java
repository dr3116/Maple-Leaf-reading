 ...
 * 杜然 12/1
 */
public class ClickFenLei5Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei5Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei5Activity newInstance(String str1) {
        ClickFenLei5Activity clickFenLei5Activity = new ClickFenLei5Activity();
        clickFenLei5Activity.str2= str1;
        return clickFenLei5Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","HTML5");
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei5Activity.this, BookIntroduction.class);
