 ...
 * 杜然 12/1
 */
public class ClickFenLei7Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei7Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei7Activity newInstance(String str1) {
        ClickFenLei7Activity clickFenLei7Activity = new ClickFenLei7Activity();
        clickFenLei7Activity.str2= str1;
        return clickFenLei7Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","Java");
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei7Activity.this, BookIntroduction.class);
