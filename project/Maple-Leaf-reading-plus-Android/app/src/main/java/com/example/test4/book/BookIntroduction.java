...
import com.example.test4.bookReadPage.LoadBookActivity;
...
//                Log.e("设置listView","成功");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("BookIntroduction.java:","开始展示图书信息");
        ...
        Glide.with(this)
                .load(ConfigUtil.SERVER_ADDR+"images/book/"+bPhoto)
                .apply(requestOptions)
                .into(bookPhoto);
        // http://192.168.43.88:8080/Maple-Leaf-Reading/images/book/2.jpg
        Log.e("--------------点开了图书介绍页面",ConfigUtil.SERVER_ADDR+"images/book/"+bPhoto);
        initData();
        initView();
        getBookReview();
        setOnclick();
    ...
    private void setOnclick() {
        ...
        bookRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                File file = new File(Environment.getExternalStorageDirectory()+"/loverReader/"+"test"+".pdf");
                if(!file.exists() || file.length() == 0) {
                    Intent intent = new Intent(BookIntroduction.this, LoadBookActivity.class);
                    ...
                    Intent intent2 = new Intent(BookIntroduction.this, PDFReadActivity.class);
                    intent2.putExtra("bookName",name);
                    intent2.putExtra("userId",userId);
                    intent2.putExtra("fileName",name+".pdf");
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址
                            .post(body)
                            .url(ConfigUtil.SERVER_ADDR + "APP/DeleteBookShelfList")
                            .build();
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址
                            .post(body)
                            .url(ConfigUtil.SERVER_ADDR + "APP/SetBookShelfList")
                            .build();
                    Call call2=client.newCall(request);
                    call2.enqueue(new okhttp3.Callback() {
                        @Override
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder()
                            // 指定访问的服务器地址
                            .post(body)
                            .url(ConfigUtil.SERVER_ADDR+"APP/GetBookReviewList")
                            .build();
