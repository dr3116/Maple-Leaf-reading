...
//                Log.e("设置listView","成功");
    ...
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei3Activity newInstance(String str1) {
        ClickFenLei3Activity clickFenLei3Activity = new ClickFenLei3Activity();
        clickFenLei3Activity.str2= str1;
        return clickFenLei3Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","Angular");
