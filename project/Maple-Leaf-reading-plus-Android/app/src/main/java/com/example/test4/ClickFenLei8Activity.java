 ...
 * 杜然 12/1
 */
public class ClickFenLei8Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei8Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei8Activity newInstance(String str1) {
        ClickFenLei8Activity clickFenLei8Activity = new ClickFenLei8Activity();
        clickFenLei8Activity.str2= str1;
        return clickFenLei8Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","Android");
    ...
    private void setListView() {
        ...
        classification.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ClickFenLei8Activity.this, BookIntroduction.class);
