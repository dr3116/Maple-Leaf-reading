...
public class ClickFenLei2Activity extends AppCompatActivity {
    private String str2;
...
//                Log.e("设置listView","成功");
    ...
    public ClickFenLei2Activity(){

    }
    //作用，参数存入str2，方便后面调用
    public static ClickFenLei2Activity newInstance(String str1) {
        ClickFenLei2Activity clickFenLei2Activity = new ClickFenLei2Activity();
        clickFenLei2Activity.str2 =str1;
        return clickFenLei2Activity;
    }
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    builder.add("classification","JQuery");
